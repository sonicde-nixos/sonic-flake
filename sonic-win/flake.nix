{
  ...
  outputs = { self, nixpkgs, flake-utils, sonic-win-source, sonic-frameworks-auth, sonic-keybind-daemon, sonic-interface-libraries, sonic-decoration, sonic-night-light }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        sonicNightLight = sonic-night-light.packages.${system}.default;
